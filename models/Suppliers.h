...
class Suppliers
{
  public:
     ...
     */
    explicit Suppliers(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Suppliers(const Json::Value &pJson) noexcept(false);
     ...
     */
    Suppliers(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Suppliers>;
    friend drogon::orm::BaseBuilder<Suppliers, true, true>;
    friend drogon::orm::BaseBuilder<Suppliers, true, false>;
    friend drogon::orm::BaseBuilder<Suppliers, false, true>;
    friend drogon::orm::BaseBuilder<Suppliers, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Suppliers>;
#endif
