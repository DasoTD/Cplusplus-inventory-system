...
Warehouses::Warehouses(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
...
void Warehouses::updateByMasqueradedJson(const Json::Value &pJson,
...
bool Warehouses::validateMasqueradedJsonForCreation(const Json::Value &pJson,
...
bool Warehouses::validateMasqueradedJsonForUpdate(const Json::Value &pJson,
                                                  const std::vector<std::string> &pMasqueradingVector,
                                                  std::string &err)
{
    if(pMasqueradingVector.size() != 4)
...
bool Warehouses::validJsonOfField(size_t index,
