...
class Warehouse
{
  public:
     ...
     */
    explicit Warehouse(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Warehouse(const Json::Value &pJson) noexcept(false);
     ...
     */
    Warehouse(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<Warehouse>;
    friend drogon::orm::BaseBuilder<Warehouse, true, true>;
    friend drogon::orm::BaseBuilder<Warehouse, true, false>;
    friend drogon::orm::BaseBuilder<Warehouse, false, true>;
    friend drogon::orm::BaseBuilder<Warehouse, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Warehouse>;
#endif
