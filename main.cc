...
void initializeDatabase() {
    ...
    try {
        ...
        if (result.size() > 0 && result[0]["count"].as<int>() == 0) {
            ...
            clientPtr->execSqlSync("INSERT INTO supplier (name, contact_person, email, phone) VALUES ('ABC Supplies', 'John Doe', 'john@abcsupplies.com', '+1234567890')");
            
            // Insert sample warehouse
            clientPtr->execSqlSync("INSERT INTO warehouse (name, location, capacity) VALUES ('Main Warehouse', '123 Storage St', 10000)");
            
            // Insert sample products
            clientPtr->execSqlSync("INSERT INTO products (sku, name, description, category, unit_price, quantity_in_stock, reorder_threshold, supplier_id, warehouse_id) VALUES ('SKU001', 'Laptop', 'Business laptop', 'Electronics', 999.99, 50, 10, 1, 1)");
            clientPtr->execSqlSync("INSERT INTO products (sku, name, description, category, unit_price, quantity_in_stock, reorder_threshold, supplier_id, warehouse_id) VALUES ('SKU002', 'Mouse', 'Wireless optical mouse', 'Electronics', 29.99, 100, 20, 1, 1)");
            clientPtr->execSqlSync("INSERT INTO products (sku, name, description, category, unit_price, quantity_in_stock, reorder_threshold, supplier_id, warehouse_id) VALUES ('SKU003', 'Keyboard', 'Mechanical keyboard', 'Electronics', 89.99, 75, 15, 1, 1)");
        }
